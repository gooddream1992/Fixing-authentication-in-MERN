...
router.route('/add').post((req, res) => {
    ...
    const newLectureItem = new LectureItem({
        lecture_id, lecture_name, course_id, title, type, url, filename, description, in_format, out_format, notes, contain, sample_input, sample_output, sample_code, test_input, test_output, check_input, check_output, score, bookmark
    });
    newLectureItem.save()
    .then((response) => {

...
class Sidebar extends React.Component {
  ...
  componentDidMount(){
    ...
    user_get(data).then(res => {
      this.setState({userData: res.user_data});
    })
    if(this.props.location.pathname === '/admin/profile'){
      this.setState({editActive: 'active'});
      this.setState({openAvatar: true});
    }
    if(this.props.location.pathname === '/admin/setting'){
  ...
  //   if(next.props !== prev.props){
  //     console.log(next.props, prev.props)
  //   }
      ...
      <div className={userWrapperClass}>
        <div className={photo}>
          {this.state.userData.image !== undefined && (
            <img src={server_url+'admin/user/img_get/'+this.state.userData.image} className={classes.avatarImg} alt="..." />
          )}
        </div>
        <List className={classes.list}>
          <ListItem className={classes.item + " " + classes.userItem}>
            ...
            >
              <ListItemText
                primary={this.state.userData.first_name+" "+this.state.userData.last_name}
                secondary={
                  <b
                    className={
                      caret +
              ...
              <List className={classes.list + " " + classes.collapseList}>
                <ListItem className={classes.collapseItem }>
                  <NavLink
                    to="/admin/profile"
                    className={
                      classes.itemLink + " " + classes.userCollapseLinks + " " + (this.props.location.pathname === '/admin/profile' ? classes.profilButton : "")
                    }
                  >
                    <span className={collapseItemMini}>
                      <AssignmentIndIcon />
                ...
                <ListItem className={classes.collapseItem}>
                  <NavLink
                    to="/admin/setting"
                    className={
                      classes.itemLink + " " + classes.userCollapseLinks + " " + (this.props.location.pathname === '/admin/setting' ? classes.profilButton : "")
                    }
                  >
                    <span className={collapseItemMini}>
                      <SettingsIcon />
